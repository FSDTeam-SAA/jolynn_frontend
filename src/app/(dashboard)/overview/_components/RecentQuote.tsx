...
export default function RecentQuote() {
  ...
  const isLoading =
    status === "loading" || (Boolean(token) && quoteQuery.isPending);
          ...
          <Table className="w-full border-collapse">
            <TableHeader className="bg-white">
              <TableRow className="border-b border-gray-100">
                <TableHead className="py-5 text-center font-medium text-slate-500 text-[14px]">
                  Name
                </TableHead>
                <TableHead className="py-5 text-center font-medium text-slate-500 text-[14px]">
                  Email Address
                ...
                <TableHead className="py-5 text-center font-medium text-slate-500 text-[14px] max-w-[300px]">
                  Details
                </TableHead>
              </TableRow>
            </TableHeader>
            ...
            <TableBody>
              {isLoading ? (
                ...
                <TableRow>
                  <TableCell
                    colSpan={6}
                    className="h-36 text-center text-sm text-red-600"
                  >
                    <p>
